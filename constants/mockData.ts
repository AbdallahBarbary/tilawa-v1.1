/**
 * Mock data for Tilawa app - teachers, sessions, categories
 */
...
export const featuredTeachers: Teacher[] = [
  {
    ...
    experience: '15 years',
    bio: 'Graduated from Al-Azhar University with ijazah in the ten Qira\'at. Dedicated to teaching the Quran with proper tajweed.',
    pricePerSession: '$25',
    isVerified: true,
    isOnline: true,
    totalStudents: 450,
  ...
  },
  {
    ...
    experience: '10 years',
    bio: 'Certified Quran teacher specializing in children\'s education. Making Quran learning fun and engaging.',
    pricePerSession: '$20',
    isVerified: true,
    isOnline: false,
    totalStudents: 320,
  ...
  },
  {
    ...
    experience: '20 years',
    bio: 'Scholar of Tafseer with deep knowledge of Quranic sciences. Teaching methodology inspired by classical scholars.',
    pricePerSession: '$30',
    isVerified: true,
    isOnline: true,
    totalStudents: 580,
  ...
  },
  {
    ...
    experience: '8 years',
    bio: 'Award-winning Quran reciter with a beautiful voice. Focuses on helping students develop melodious recitation.',
    pricePerSession: '$22',
    isVerified: true,
    isOnline: true,
    totalStudents: 210,
  ...
  },
  {
    ...
    languages: ['Arabic', 'English'],
    experience: '12 years',
    bio: 'Hafidha with ijazah in Hafs. Passionate about helping women and children complete their Quran memorization journey.',
    pricePerSession: '$18',
    isVerified: true,
    isOnline: false,
    totalStudents: 390,
...
export const upcomingSessions: Session[] = [
  ...
  },
  {
    ...
    teacherAvatar: 'https://i.pravatar.cc/300?img=23',
  ...
  },
  {
    ...
    teacherAvatar: 'https://i.pravatar.cc/300?img=33',
...
export const completedSessions: Session[] = [
  ...
  },
  {
    ...
    teacherAvatar: 'https://i.pravatar.cc/300?img=47',
